        ...
        <div class="collapse navbar-collapse " id="navbarNavDropdown">
          @guest
            <form action="" class="ms-auto">
              <button type="submit" class="btn-danger btn" onclick="event.preventDefault(); location.href='{{url('/login')}}'">Sign in</button>
            </form>
          @if (Route::has('register'))
            <form action="" class="me-3">
              <button type="submit" class="btn btn-outline-dark" onclick="event.preventDefault(); location.href='{{url('/register')}}'" style="outline: none; color:white">Sign Up</button>
            </form>
          @endif
