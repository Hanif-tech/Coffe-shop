...
<main>
    <section id="header">
      ...
      <div class="content text-center">
          <h1>Graha Asri</h1>
          <p>enjoy your day with a cup of coffee.</p>
      </div>
  </section>
  <section id="product-list" style="background-color: rgb(240, 240, 240)">
    <div class="container">
        <div class="row py-5">
            <h2 class="text-center mb-5" style="color: rgb(61, 61, 61);font-size: 38px; font-weight: 600;">Our Products</h2>
            ...
            <div class="d-flex justify-content-center mt-5 ">
                <a href="{{route('all-product')}}" class="shadow btn btn-dark px-5 py-2 rounded-2">See More</a>
            </div>
        </div>
